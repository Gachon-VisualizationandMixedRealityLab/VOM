    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var num = 0; num < rowArr.length; num++) {
                ...
                content = full_text[2]; // title 
                content1 = full_text[3]; //period or name
                content2 = full_text[4]; // institution or school/institution
                content3 = full_text[5]; // tag
                ...
                if (category !== undefined && num > 0) {
                    ...
                    switch (category) {
                        case "1":
                            ul_list = $("#active-projects");

                            ul_list.append(
                                `<li class="grant-item active-project">
                                    <div class="grant-content">
                                        <div class="grant-image">
                                            <img src="assets/images/grant/${imagelink}" alt="${content}">
                                        </div>
                                        <div class="grant-info">
                                            ...
                                            <div class="grant-meta">
                                                <span class="agency-badge">${content2}</span>
                                                ${content3 ? `<span class="agency-badge">${content3}</span>` : ''}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="grant-period">${content1}</div>
                                </li>`
                            )
                            break;
                        case "2":
                            ul_list = $("#completed-projects");
                            ul_list.append(
                                `<li class="grant-item">
                                    <div class="grant-content">
                                        <div class="grant-image">
                        ...
                        case "3":
                            ...
                            ul_list.append(
                                `<div class="collaborator-card">
                                    <img src="assets/images/grant/${imagelink}" class="collaborator-logo">
                                    <div class="collaborator-info">
                                        <p class="collaborator-role">${content}</p>
                                        <h4 class="collaborator-name">${content1}</h4>
                                        <p class="collaborator-desc">${content2}</p>
                                    </div>
                                </div>`
                                )   
                            break;                                                      
